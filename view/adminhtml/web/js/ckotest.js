...
define([
    ...
    'Cko_Test/js/view/payment/sadad-client'
], function ($, Class, alert, SadadClient) {
    'use strict';
    ...
    return Class.extend({
        defaults: {
            ...
            $selector: null,
            selector: 'edit_form',
            container: 'payment_form_cko_test',
            active: false,
            imports: {
        ...
        submitOrder: function () {
            ...
            this.sadadClient.createTokens(secureData)
                .always(function () {
        ...
        enableEventListeners: function () {
            this.$selector.on('submitOrder.ckotest', this.submitOrder.bind(this));
        },
